      ...
      <Layout>
        <article className="about-my-code-article">
          ...
          <p className="normal-text code-article-text">
            I have experience in programming, artificial intelligence, front-end and back-end. I strive to write clear and easy-to-maintain code, always
            aiming for excellence and adaptability in my projects.
          </p>
        </article>
